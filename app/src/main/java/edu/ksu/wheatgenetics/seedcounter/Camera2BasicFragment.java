...
public class Camera2BasicFragment extends Fragment
    ...
    private Size chooseHighSpeedVideoSize(Size[] choices) {
        for (Size s: choices) {
    ...
    private String getVideoFilePath() {
        ...
        final File dir = getActivity().getExternalFilesDir("DCIM");
        return new File(getActivity().getExternalFilesDir("DCIM"), "VID_" + System.currentTimeMillis() + ".webm").getAbsolutePath();
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, new Range<>(120, 120));
        ...
        try {
            if (mRecording) {
                ...
                List<CaptureRequest> highSpeedRequest =
                        mHighSpeedCaptureSession.createHighSpeedRequestList(mPreviewRequestBuilder.build());
                mHighSpeedCaptureSession.setRepeatingBurst(highSpeedRequest, null, mBackgroundHandler);
            } else {
    ...
    private void stopVideoCapture() {
        ...
        try {
            ...
            final Intent startProcessingFromFile = new Intent(getActivity(), FileVideoCaptureActivity.class);
        ...
        try {
            ...
            mCameraDevice.createConstrainedHighSpeedCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                    ...
                    mHighSpeedCaptureSession = (CameraConstrainedHighSpeedCaptureSession) mCaptureSession;
                    updatePreview();
                }
